      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400 mt-2">실시간 서버 자원 사용 현황</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border-blue-500/20">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="text-sm text-slate-400">CPU 사용률</p>
          ...
          <Card className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-500/20">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="text-sm text-slate-400">메모리 사용률</p>
          ...
          <Card className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border-green-500/20">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="text-sm text-slate-400">디스크 사용률</p>
          ...
          <Card className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border-orange-500/20">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-slate-400">네트워크</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white font-medium">Intel Xeon E5-2680 v4</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">코어 수</span>
                  <span className="text-white font-medium">16 코어 / 32 스레드</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">클럭 속도</span>
                  <span className="text-white font-medium">2.4 GHz</span>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="pt-4 border-t border-slate-700">
                <p className="text-sm text-slate-400 mb-3">코어별 사용률</p>
                <div className="grid grid-cols-4 gap-2">
                  {[...Array(16)].map((_, i) => {
                    const usage = Math.floor(Math.random() * 100);
                    return (
                      <div key={i} className="text-center">
                        <div className="h-16 bg-slate-900/50 rounded-lg relative overflow-hidden">
                          <div 
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">총 메모리</span>
                  <span className="text-white font-medium">64 GB</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">사용 중</span>
                  <span className="text-white font-medium">39.7 GB</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">캐시</span>
                  <span className="text-blue-400 font-medium">12.8 GB</span>
                </div>
              </div>

              <div className="pt-4 border-t border-slate-700">
                <p className="text-sm text-slate-400 mb-3">메모리 사용 분포</p>
                <div className="space-y-2">
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm text-slate-400">시스템</span>
                      <span className="text-sm text-white">8.2 GB</span>
                    </div>
                    <Progress value={13} className="h-2" />
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm text-slate-400">애플리케이션</span>
                      <span className="text-sm text-white">25.6 GB</span>
                    </div>
                    <Progress value={40} className="h-2" />
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm text-slate-400">데이터베이스</span>
                      <span className="text-sm text-white">5.9 GB</span>
                    </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">사용 중</span>
                  <span className="text-white font-medium">760 GB</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">사용 가능</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">디스크 타입</span>
                  <span className="text-white font-medium">SSD NVMe</span>
                </div>
              </div>

              <div className="pt-4 border-t border-slate-700">
                <p className="text-sm text-slate-400 mb-3">파티션별 사용량</p>
                <div className="space-y-3">
                  <div className="p-3 rounded-lg bg-slate-900/50 border border-slate-700">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-medium">/</span>
                      <span className="text-sm text-slate-400">350 GB / 500 GB</span>
                    </div>
                  ...
                  <div className="p-3 rounded-lg bg-slate-900/50 border border-slate-700">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-slate-400">410 GB / 1.5 TB</span>
                    </div>
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">수신 속도</span>
                  <span className="text-green-400 font-medium">{networkIn.toFixed(2)} MB/s</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">송신 속도</span>
                  <span className="text-blue-400 font-medium">{networkOut.toFixed(2)} MB/s</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">총 수신량 (24시간)</span>
                  <span className="text-white font-medium">156.3 GB</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">총 송신량 (24시간)</span>
                  <span className="text-white font-medium">89.7 GB</span>
                </div>
              </div>

              <div className="pt-4 border-t border-slate-700">
                <p className="text-sm text-slate-400 mb-3">활성 연결</p>
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2 rounded bg-slate-900/50">
                    <span className="text-sm text-slate-400">HTTP/HTTPS</span>
                    <span className="text-sm text-white">342 연결</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded bg-slate-900/50">
                    <span className="text-sm text-slate-400">데이터베이스</span>
                    <span className="text-sm text-white">28 연결</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded bg-slate-900/50">
                    <span className="text-sm text-slate-400">WebSocket</span>
                    <span className="text-sm text-white">156 연결</span>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                ...
                <div>
                  <p className="text-white font-medium">메모리 사용률 높음</p>
              ...
              {diskUsage > 80 && (
                <div className="flex items-start gap-3 p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                  ...
                  <div>
                    <p className="text-white font-medium">디스크 공간 부족</p>
                    <p className="text-sm text-slate-400 mt-1">
