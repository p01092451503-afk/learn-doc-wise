  ...
  const getDefaultMenuItems = () => {
    ...
    if (effectiveUserRole === "teacher") {
      return [
        ...
        { icon: CalendarCheck, label: "출결 상세", path: "/teacher/attendance-detail", enabled: true },
        ...
        { icon: Users, label: "중도탈락 관리", path: "/teacher/dropout-management", enabled: true },
        { icon: Trophy, label: "수료 요건", path: "/teacher/training-completion", enabled: true },
        { icon: DollarSign, label: "훈련수당", path: "/teacher/training-allowance", enabled: true },
        { icon: BarChart3, label: "훈련 리포트", path: "/teacher/training-report", enabled: true },
