  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "bg-background border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground hover:shadow-premium transition-all",
        secondary: "bg-secondary text-secondary-foreground shadow-premium hover:shadow-elegant hover:scale-[1.02] active:scale-[0.98]",
        ghost: "bg-primary/15 text-foreground border border-primary/30 hover:bg-primary/25 hover:text-primary hover:border-primary/50 transition-all",
