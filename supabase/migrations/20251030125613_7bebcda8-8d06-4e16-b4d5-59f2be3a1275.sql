-- Update admin menu: Change "사용자 관리" to "회원 관리"
UPDATE menu_order 
SET menu_items = '[
  {"id":"dashboard","icon":"LayoutDashboard","label":"대시보드","path":"/admin","enabled":true},
  {"id":"users","icon":"Users","label":"회원 관리","path":"/admin/users","enabled":true},
  ...
  {"id":"tenants","icon":"Building2","label":"테넌트 관리","path":"/admin/tenants","enabled":true},
